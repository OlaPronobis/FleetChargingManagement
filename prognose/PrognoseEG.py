...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 26 09:56:51 2020
...
class PrognoseEG():
    ...
    def run(self,timeindex):
        ...
        self.df['Prognose']= self.df[['Erdgas']].shift(-self.forecast_out)
        self.df.tail()
        ...
        #return self.result3
        np.savetxt('./prognose/Prognose_Erdgas.csv', self.lr_predection, delimiter=';')
