...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 26 11:39:23 2020
...
class PrognoseGE():
    ...
    def run(self,timeindex):
        ...
        self.df['Prognose']= self.df[['GesamteerzeugteEnergie']].shift(-self.forecast_out)
        self.df.tail()
        ...
        #return self.result3
        np.savetxt('./prognose/Prognose_GesamteerzeugteEnergie.csv', self.lr_predection, delimiter=';')
