...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 26 09:42:56 2020
...
class PrognoseSonstig():
    ...
    def run(self,timeindex):
        ...
        self.df['Prognose']= self.df[['SonstigeKonventionelle']].shift(-self.forecast_out)
        self.df.tail()
        ...
        #return self.result3
        np.savetxt('./prognose/Prognose_SonstigeKonventionelle.csv', self.lr_predection, delimiter=';')
