...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 26 09:52:14 2020
...
class PrognoseSK():
    ...
    def run(self,timeindex):
        ...
        self.df['Prognose']= self.df[['Steinkohle']].shift(-self.forecast_out)
        self.df.tail()
        ...
        #return self.result3
        np.savetxt('./prognose/Prognose_Steinkohle.csv', self.lr_predection, delimiter=';')
